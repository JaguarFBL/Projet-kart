...
function updateBatterie(capteur, historique, stats) {
  ...
  if (historique && historique.length > 0) {
    ...
    const voltData  = historique.map(r => r.tensionbatterie      !== null ? parseFloat(r.tensionbatterie)    : null);
    const ampData   = historique.map(r => r.intensitebatterie    !== null ? parseFloat(r.intensitebatterie)  : null);
    ...
    chartBattFull.data.datasets[2].data = voltData;
    chartBattFull.data.datasets[3].data = ampData;
